...
interface MealManagerListener {
    void mealsUpdated();
    void ingredientsUpdated();
    void foodEventsUpdated();
}
...
public class MealManager {
    ...
    ArrayList<FoodEvent>foodEvents = new ArrayList<FoodEvent>();
    ...
    public Ingredient addIngredient(Ingredient ingredient) {
        ...
        for (int ct = 0; ct < ingredients.size(); ct++) {
            if (ingredients.get(ct).getApiID().equals(ingredient.getApiID())) {

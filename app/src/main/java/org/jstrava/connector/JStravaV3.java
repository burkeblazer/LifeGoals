...
public class JStravaV3 implements JStrava {
    ...
    @Override
    public List<org.jstrava.entities.activity.Zone> getActivityZones(int activityId) {
        String URL="https://www.strava.com/api/v3/activities/"+activityId+"/zones";
        String result=getResult(URL);
        Gson gson= new Gson();
        org.jstrava.entities.activity.Zone[] zonesArray=gson.fromJson(result, org.jstrava.entities.activity.Zone[].class);
        List<org.jstrava.entities.activity.Zone> zones=Arrays.asList(zonesArray);
        return zones;
    }


    @Override
    public List<org.jstrava.entities.activity.LapEffort> findActivityLaps(int activityId) {
        String URL="https://www.strava.com/api/v3/activities/"+activityId+"/laps";
        String result=getResult(URL);
        Gson gson= new Gson();
        org.jstrava.entities.activity.LapEffort[] lapEffortsArray =gson.fromJson(result, org.jstrava.entities.activity.LapEffort[].class);
        List<org.jstrava.entities.activity.LapEffort>lapEfforts= Arrays.asList(lapEffortsArray);
        return lapEfforts;
    }
    ...
    @Override
    public org.jstrava.entities.activity.UploadStatus uploadActivity(String data_type, File file) {
        return null;
    }

    @Override
    public org.jstrava.entities.activity.UploadStatus uploadActivity(String activity_type, String name, String description, int is_private, int trainer, String data_type, String external_id, File file) {
        return null;
    }

    @Override
    public org.jstrava.entities.activity.UploadStatus checkUploadStatus(int uploadId) {

        String URL="https://www.strava.com/api/v3/uploads/"+uploadId;
        String result= getResult(URL);
        Gson gson= new Gson();
        org.jstrava.entities.activity.UploadStatus status=gson.fromJson(result, org.jstrava.entities.activity.UploadStatus.class);

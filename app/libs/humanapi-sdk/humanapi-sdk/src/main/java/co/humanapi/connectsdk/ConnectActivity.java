...
public class ConnectActivity extends Activity {
    ...
    private void onFinish(String url) {
        ...
        data.put("clientSecret", "5b6855399c0f6f4aef36203e0793735c0254ee7c");

        try {
            JSONResource res = resty.json("https://user.humanapi.co/v1/connect/tokens", resty.content(new JSONObject(data)));
